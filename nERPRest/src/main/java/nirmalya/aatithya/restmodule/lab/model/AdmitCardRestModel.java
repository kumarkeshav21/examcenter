...
public class AdmitCardRestModel {
	...
	public AdmitCardRestModel() {
		super();
		// TODO Auto-generated constructor stub
	}

	public AdmitCardRestModel(Object roll, Object applicationNo, Object candiName, Object candiFatherName,
			Object gender, Object dateOfBirth, Object catogary, Object personWithDisablity,
			Object barCode, Object signature, Object quesPaperMedium, Object dateOfExam, Object reportingTime,
			Object gateClosingTime, Object testCenterName, Object testCenterAddress, Object seniorDirectorSignature) {
		
		super();
		this.roll = (String) roll;
		this.applicationNo = (String) applicationNo;
		this.candiName = (String) candiName;
		this.candiFatherName = (String) candiFatherName;
		this.gender = (String) gender;
		this.dateOfBirth = (String) dateOfBirth;
		this.catogary = (String) catogary;
		this.personWithDisablity = (String) personWithDisablity;
		this.barCode = (String) barCode;
		this.signature = (String) signature;
		this.quesPaperMedium = (String) quesPaperMedium;
		this.dateOfExam = (String) dateOfExam;
		this.reportingTime = (String) reportingTime;
		this.gateClosingTime = (String) gateClosingTime;
		this.testCenterName = (String) testCenterName;
		this.testCenterAddress = (String) testCenterAddress;
		this.seniorDirectorSignature = (String) seniorDirectorSignature;
	}
